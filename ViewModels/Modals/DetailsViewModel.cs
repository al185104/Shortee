...
public partial class DetailsViewModel : BaseViewModel
{
    ...
    [RelayCommand]
    async Task BarcodeTappedAsync()
    {
        if (_shortURL == null || string.IsNullOrEmpty(_shortURL.OriginalUrl)) return;

        var entity = await _dataService.ShortURLRepo.GetByShortenedUrlAsync(_shortURL.ShortenedUrl);
        ...
        //if (await Launcher.CanOpenAsync(entity.OriginalUrl))
